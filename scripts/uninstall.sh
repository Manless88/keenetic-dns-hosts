...
warn "Dependencies such as python3 and curl were not removed because other Entware packages may use them."
warn "If you are sure they are no longer needed, remove them manually: opkg remove python3 curl"
