...
Зависимости `python3` и `curl` автоматически не удаляются, потому что они могут использоваться другими Entware-пакетами. Если они точно больше не нужны, их можно удалить вручную: `opkg remove python3 curl`.
